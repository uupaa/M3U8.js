...
var M3U8 = {
    ...
    "defaultFilter":     M3U8_defaultFilter,     // M3U8.defaultFilter(masterStreams:MasterStreamObjectArray, videoCanPlay:RegExp = /^(Base|Main)/, audioCanPlay:RegExp = /AAC/):UINT8 - stream-index or 255
...
function M3U8_loadMediaPlaylist(url,                  // @arg URLString - MasterPlaylist or MediaPlaylist
                                readyCallback,        // @arg Function - readyCallback(m3u8:M3U8FormatString, url:URLString, playlist:MediaPlaylistObject):void
                                errorCallback,        // @arg Function = null - errorCallback(error:Error, url:URLString):void
...
//}@dev
    ...
    M3U8_load(url, function(m3u8, m3u8URL) {
        ...
        case "VOD":
        case "LIVE":   readyCallback(m3u8, m3u8URL, playlist);
        }
...
function M3U8_defaultFilter(masterStreams,  // @arg MasterStreamObjectArray - [MasterStreamObject, ...]
                            videoCanPlay,   // @options.videoCanPlay RegExp = /^(Base|Main)/ - video can play profile.
