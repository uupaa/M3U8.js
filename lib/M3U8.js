...
var M3U8 = {
    ...
    "filter":       M3U8_filter, // M3U8.filter(playlist:IndexPlaylistObject, index:UINT32 = 0, threshold:Number = 3.0):IndexPlaylistStreamObject
...
function M3U8_filter(playlist,    // @arg IndexPlaylistObject
                     ...
                     threshold) { // @arg Number = 3.0 - minimum duration
                                  // @ret IndexPlaylistObject
//{@dev
    if (VERIFY) {
        ...
        $valid($type(threshold, "Number|omit"),        M3U8_filter, "threshold");
    }
//}@dev

    index     = index || 0;
    threshold = threshold === undefined ? 3.0 : threshold;
