...
var M3U8 = {
    ...
    "loadMediaPlaylist":
                    M3U8_loadMediaPlaylist, // M3U8.loadMediaPlaylist(url:PlaylistURLString, readyCallback:Function, errorCallback:Function = null, streamSelectCallback:Function = null, options:Object = null):void
...
function M3U8_loadMediaPlaylist(url,                  // @arg URLString - MasterPlaylist or MediaPlaylist
                                ...
                                errorCallback,        // @arg Function = null - errorCallback(error:Error, url:URLString):void
                                streamSelectCallback, // @arg Function = null - streamSelectCallback(streams:MasterStreamObjectArray):UINT8
                                options) {            // @arg Object = null - { timeout:UINT32 }
//{@dev
    if (VERIFY) {
        ...
        $valid($type(streamSelectCallback, "Function|omit"), M3U8_loadMediaPlaylist, "streamSelectCallback");
...
//}@dev
    ...
    streamSelectCallback = streamSelectCallback || function() { return 0; };

    M3U8_load(url, function(m3u8, m3u8URL) {
        var playlist = M3U8_parse(m3u8, m3u8URL); // MasterPlaylistObject|MediaPlaylistObject

        switch (playlist["type"]) {
        case "MASTER": _parseMasterPlaylist(playlist["streams"], streamSelectCallback(playlist["streams"]), m3u8URL); break;
        case "VOD":
