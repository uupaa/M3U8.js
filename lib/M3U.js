...
function M3U_build(playList) { // @ret MasterPlayListObject|IndexPlayListObject - MasterPlayListObject = { VERSION, MASTER, STREAM:[{ URL, CODECS, BANDWIDTH, RESOLUTION }, ...] }
...
//}@dev
    ...
    var lines = ["#EXTM3U"];
    var isMasterPlayList = !!playList["MASTER"];
