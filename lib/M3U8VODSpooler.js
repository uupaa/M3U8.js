...
function M3U8VODSpooler(url,       // @arg URLString
                        options) { // @arg Object - { durationThreshold, overthresholdCallback, errorCallback, fetchM3U8Callback, loadTSCallback }
                                   ...
                                   // @options.fetchM3U8Callback     Function = null - fetchM3U8Callback(url:URLString, m3u8:String):void
                                   // @options.loadTSCallback        Function = null - loadTSCallback(url:URLString, tsIndex:UINT32, blob:Blob):void
    ...
    this._fetchM3U8Callback     = options["fetchM3U8Callback"] || function() {
        if (M3U8VODSpooler["VERBOSE"]) {
            console.info("M3U8VODSpooler::fetched M3U8", event["type"], event["detail"]);
        }
    };
    this._loadTSCallback        = options["loadTSCallback"] || function(url, tsIndex, blob) {
        if (M3U8VODSpooler["VERBOSE"]) {
            console.info("M3U8VODSpooler::loaded MPEG2-TS", url, tsIndex, blob["size"]);
        }
    };
...
M3U8VODSpooler["prototype"] = Object.create(M3U8VODSpooler, {
    ...
    "has":          { "value": M3U8VODSpooler_has     }, // M3U8VODSpooler#has(ms:UINT32):Boolean
    "use":          { "value": M3U8VODSpooler_use     }, // M3U8VODSpooler#use(ms:UINT32):ChunkObject|null
    "seek":         { "value": M3U8VODSpooler_seek    }, // M3U8VODSpooler#seek(seekTime:UINT32):Object|null - { index, startTime, endTime }
    "start":        { "value": M3U8VODSpooler_start   }, // M3U8VODSpooler#start():void
    "stop":         { "value": M3U8VODSpooler_stop    }, // M3U8VODSpooler#stop():void
    "clear":        { "value": M3U8VODSpooler_clear   }, // M3U8VODSpooler#clear():void
    "release":      { "value": M3U8VODSpooler_release }, // M3U8VODSpooler#release(indexes:UINT32Array):void
    ...
    if (this._src) {
        ...
        M3U8["load"](this._src, function(m3u8, url) {
            ...
            if (that._lastM3U8String !== m3u8) { // modified?
                ...
                that._fetchM3U8Callback(url, m3u8);
...
function _cache(that) {
    ...
    function _onloaded(url, tsIndex, blob) {
        ...
        that._loadTSCallback(url, tsIndex, blob);
