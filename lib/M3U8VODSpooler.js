...
function M3U8VODSpooler(url,                   // @arg URLString
                          durationThreshold,     // @arg UINT32 - ms
                          overthresholdCallback, // @arg Function - fetchCallback(cachedDuration:UINT32):void
                          errorCallback) {       // @arg Function - errorCallback(event:Object):void
    this._src                   = url;  // IndexPlaylistObject
    this._durationThreshold     = durationThreshold;
    this._overthresholdCallback = overthresholdCallback;
    this._errorCallback         = errorCallback; // { type: "error", detail: { url, code } } or { type: "timeout", detail: { url, code } }
